...
import { ButtonHover, ButtonPadding, Dark, H1, Primary, Secondary } from "../../utils";
...
const initialRows = [
  ...
  { houseNo: '5', name: "Daenerys", address: "valancia", city: "Lahore" , levels:"4"},
  {
    houseNo: '6',
    name: "dvd",
          ...
          <Button
            ...
            >
              <Select
                value={selectedValue}
                onChange={handleSelectChange}
                style={{ fontSize:"16px", padding:"4px 10px", alignItems:"center" }}
              >
                <option value="volvo" selected >
                  {t("Add Maps")}
                </option>
